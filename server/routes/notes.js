...
// This could be useful for showing counts in your React app
router.get("/stats/summary", async (req, res) => {
  try {
    const [totalNotes, activeNotes, pinnedNotes, deletedNotes] =
      await Promise.all([
        Note.countDocuments(),
        Note.countDocuments({ isDeleted: false }),
        Note.countDocuments({ isDeleted: false, isPinned: true }),
